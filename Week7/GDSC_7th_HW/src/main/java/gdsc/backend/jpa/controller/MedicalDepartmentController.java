...
public class MedicalDepartmentController {
    ...
    @PostMapping()
    public void createHospital(@RequestBody CreateMedicalDepartmentDto createMedicalDepartmentDto) {
        medicalDepartmentService.createHospital(createMedicalDepartmentDto);
    }
}
